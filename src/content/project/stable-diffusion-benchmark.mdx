...
To shed light on these questions, we present an [inference benchmark](https://github.com/LambdaLabsML/lambda-diffusers/tree/eole/benchmarking#benchmarking-inference) of Stable Diffusion on different GPUs and CPUs. These are our findings:
