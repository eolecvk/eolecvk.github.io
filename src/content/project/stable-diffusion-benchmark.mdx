...
description: "All You Need Is One GPU"
intro: "All You Need Is One GPU"
features:
  - name: Author
    value: Eole Cervenka
  - name: Citation
    value: https://arxiv.org/pdf/2301.00704#page=17
  - name: Note
    value: This article was originally published on [Lambda Labs' blog](https://lambda.ai/blog/inference-benchmark-stable-diffusion).
style:
  template: split
  card_template: grid
  hero_template: image
...
<br />
<p align="center">
  <img src="https://huggingface.co/datasets/hf-internal-testing/diffusers-images/resolve/main/sd_benchmark/thumbnail.png" alt="Stable Diffusion Benchmark" />
</p>
<br />


**UPDATE 2022-Oct-13 (Turning off autocast for FP16 speeds inference up by 25%)**
...
Last but not least, we are excited to see how quickly things are moving forward by the community. For example, the "[sliced attention](https://github.com/huggingface/diffusers/pull/234)" trick can further reduce the VRAM cost to "as little as 3.2 GB", at a small penalty of about 10% slower inference speed. We also look forward to testing ONNX Runtime with CUDA devices once it becomes more stable in the near future.
...
<p align="center">
  <img src="https://huggingface.co/datasets/hf-internal-testing/diffusers-images/resolve/main/sd_benchmark/speed.png" alt="Stable Diffusion Text2Image Speed" />
  <br />
  <b>Stable Diffusion Text2Image Speed (in seconds)</b>
</p>
...
- We believe Ampere GPUs enjoy a relatively "smaller" speedup from half-precision due to their use of TF32. For readers unfamiliar with TF32, it is a 19-bit format that has been used as the default single-precision data type on Ampere GPUs for major deep learning frameworks such as PyTorch and TensorFlow. One can expect half-precision's speedup over FP32 to be bigger since FP32 is a true 32-bit format.
- We run these same inference jobs on CPU devices to put in perspective the performance observed on GPU devices.

<p align="center">
  <img src="https://huggingface.co/datasets/hf-internal-testing/diffusers-images/resolve/main/sd_benchmark/gpu_vs_cpu.png" alt="Stable Diffusion Text2Image GPU vs CPU" />
  <br />
  <b>Stable Diffusion Text2Image GPU vs CPU</b>
</p>
...
- As a side note, ONNX Runtime currently does not have stable CUDA backend support for Hugging Face diffusers, nor did we observe meaningful speedup in our preliminary `CUDAExecutionProvider` tests. We look forward to conducting a more thorough benchmark once ONNX Runtime becomes more optimized for Stable Diffusion.
...
<p align="center">
  <img src="https://huggingface.co/datasets/hf-internal-testing/diffusers-images/resolve/main/sd_benchmark/memory.png" alt="Stable Diffusion Text2Image Memory" />
  <br />
  <b>Stable Diffusion Text2Image Memory (GB)</b>
</p>
...
<p align="center">
  <img src="https://huggingface.co/datasets/hf-internal-testing/diffusers-images/resolve/main/sd_benchmark/throughput.png" alt="Stable Diffusion Text2Image Throughput" />
  <br />
  <b>Stable Diffusion Text2Image Throughput (images/minute)</b>
</p>
...
<p align="center">
  <img src="https://huggingface.co/datasets/hf-internal-testing/diffusers-images/resolve/main/sd_benchmark/batch_size_vs_throughput.png" alt="Stable Diffusion Text2Image Batch size vs Throughput" />
  <br />
  <b>Stable Diffusion Text2Image Batch size vs Throughput (images/minute)</b>
</p>

## Autocast

An update made by the Hugging Face team to the diffusers code showed that removing autocast speeds up inference with PyTorch at half-precision by ~25%.
