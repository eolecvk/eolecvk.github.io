...
description: Stable Diffusion Inference Benchmark cited by Google Research
intro: Stable Diffusion Inference Benchmark cited by Google Research
features:
  - name: Citation in Google Research "Muse" paper
