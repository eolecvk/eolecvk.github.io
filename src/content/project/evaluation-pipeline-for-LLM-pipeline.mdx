...
## What I learned from building an AI-powered News Site
...
<p align="center">
  <img src="/src/assets/ml-times.png" alt="ML Times homepage" width="700" />
</p>
...
We refer to this sequence of processing steps as "chain" or "workflow". A failure at any point can lead to issues degrading the quality of content on the website. Most common issues originated from:
...
<p align="center">
  <img src="/src/assets/ml-times-workflow.png" alt="ML Times workflow" width="1000" />
</p>
